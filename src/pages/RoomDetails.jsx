...
const RoomDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-luxury-gold selection:text-white">
      {/* Premium Header */}
      <nav className="fixed top-0 w-full z-50 transition-all duration-700 bg-white/80 backdrop-blur-2xl border-b border-luxury-gold/10 py-6">
        <div className="container mx-auto px-8 flex justify-between items-center">
          <Link to="/search" className="flex items-center gap-3 group text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 hover:text-luxury-black transition-all">
          ...
          <div className="flex items-center gap-8">
             <button className="p-3 hover:bg-gray-50 rounded-2xl transition-colors"><Share2 className="w-5 h-5 text-gray-400" /></button>
             <button className="p-3 hover:bg-gray-50 rounded-2xl transition-colors"><Heart className="w-5 h-5 text-gray-400" /></button>
             <GoldButton 
               className="px-10 py-3 text-[10px]"
        ...
        <section className="container mx-auto px-8 mb-20">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-[700px]">
              <motion.div 
                ...
                className="lg:col-span-8 rounded-[3rem] overflow-hidden relative group cursor-zoom-in shadow-2xl"
              >
                 ...
                 <div className="absolute bottom-10 left-10 text-white flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl glass flex items-center justify-center"><Maximize2 className="w-5 h-5" /></div>
                    <span className="text-xs font-bold uppercase tracking-[0.4em]">Expand Sanctuary View</span>
                 </div>
              </motion.div>
              <div className="lg:col-span-4 grid grid-rows-3 gap-8">
                 {room.images.slice(1, 4).map((img, i) => (
                   <motion.div
                     ...
                     onClick={() => {
                       const oldMain = room.images[selectedImage];
                       // Simple swap logic would be better but this is a quick gallery
                       setSelectedImage(room.images.indexOf(img));
                     }}
                     className="rounded-[2.5rem] overflow-hidden relative cursor-pointer group shadow-xl border border-gray-100"
                   >
           ...
           <div className="grid lg:grid-cols-3 gap-24">
              ...
              <div className="lg:col-span-2 space-y-16">
                 <div className="space-y-8">
                    <div className="flex items-center gap-4">
                       ...
                       <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-400">Official 5-Star Gilded Rating</span>
                    </div>
                    <h1 className="text-6xl md:text-8xl font-serif font-bold text-luxury-black leading-[0.9]">
                       {room.type} <br /> <span className="italic font-normal text-luxury-gold">Sanctuary</span>
                    </h1>
                    <div className="flex flex-wrap gap-10 py-8 border-y border-gray-100">
                       <div className="flex items-center gap-4">
                       ...
                       <div className="flex items-center gap-4">
                          <Sun className="text-luxury-gold w-5 h-5" />
                          <div>
                             <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Exposure</p>
                       ...
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Vibe</p>
                 ...
                 <div className="space-y-10">
                    <h3 className="text-3xl font-serif font-bold">A Masterpiece of Hospitality</h3>
                          ...
                          <div className="grid grid-cols-1 gap-6">
                             {room.amenities?.map((a, i) => (
                               <div key={i} className="flex items-center gap-5 group">
                                  <div className="w-12 h-12 rounded-2xl bg-gray-50 flex items-center justify-center text-luxury-gold border border-gray-100 group-hover:bg-luxury-gold group-hover:text-white transition-all duration-500">
                       ...
                       <div className="space-y-6">
                          ...
                          <ul className="space-y-6">
                             {[
                               ...
                               'In-Room Traditional Algerian Tea Service',
                               'Priority Access to Gilded Spa',
                               'Valet & Luxury Transport Priority'
                             ].map((text, i) => (
              ...
              <div className="lg:col-span-1">
                 <div className="sticky top-44 space-y-8">
                    <GlassCard className="bg-white p-12 shadow-[0_50px_100px_-30px_rgba(0,0,0,0.15)] border-luxury-gold/10 rounded-[3.5rem] relative overflow-hidden">
                       <div className="absolute top-0 left-0 w-full h-2 gold-gradient" />
                       <div className="space-y-10">
                          <div className="flex justify-between items-end">
                             <div>
                                <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 mb-2">Sanctuary Rate</p>
                                <h3 className="text-5xl font-serif font-bold text-luxury-black">{formatPrice(room.price)}</h3>
                             </div>
                             <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-2">/ Evening</p>
                          </div>
                             ...
                             <div className="p-6 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                   <div className="flex items-center gap-3">
                                      ...
                                      <span className="font-bold text-sm">{checkIn} — {checkOut}</span>
                                   </div>
                                   <span className="text-xs font-bold text-luxury-black">6 Nights</span>
                                </div>
                             </div>
                             
                             <div className="p-6 bg-luxury-gold/5 rounded-[2rem] border border-luxury-gold/10 space-y-4">
                                <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-widest text-luxury-gold">
                          ...
                          <div className="space-y-6">
                             ...
                             <GoldButton 
                               className="w-full py-6 text-xs shadow-2xl hover:scale-105 transition-all"
                               onClick={() => navigate(`/book/${id}?checkIn=${checkIn}&checkOut=${checkOut}&guests=${guests}`)}
                             >
                          ...
                          <div className="flex items-center justify-center gap-6 text-[10px] font-bold uppercase tracking-widest text-gray-300">
                    ...
                    <div className="bg-orange-50 border border-orange-100 p-8 rounded-[2.5rem] flex items-center gap-6 group">
                       <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-sm shrink-0 group-hover:scale-110 transition-transform">
                          <Clock className="w-6 h-6 text-orange-500 animate-pulse" />
                       </div>
                       <div>
                          <p className="text-sm font-bold text-orange-600 mb-1">High Demand</p>
                          <p className="text-xs text-orange-600/70 font-medium">This suite was last reserved 4 hours ago. Don't miss your chance.</p>
                       </div>
                    </div>
                 </div>
              </div>
         ...
         <div className="container mx-auto px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               <div>
                  ...
                  <h2 className="text-5xl md:text-7xl font-serif font-bold mb-10 leading-tight">Elevate Your <br /> Stay in Setif</h2>
                  <p className="text-white/40 text-xl font-medium leading-relaxed max-w-xl mb-12 italic">
                     "True luxury is found in the moments between. Curate your experience with our exclusive add-ons."
                  </p>
                  <GoldButton outline className="px-12 py-5 text-xs text-white border-white/20 hover:border-luxury-gold transition-all">DISCOVER ADD-ONS</GoldButton>
               </div>
               <div className="grid grid-cols-2 gap-8">
                  {[
                    ...
                    <motion.div 
                      key={i}
                      whileHover={{ y: -10 }}
                      className="aspect-[4/5] rounded-[2.5rem] overflow-hidden relative group cursor-pointer"
                    >
                       ...
                       <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8">
                          <p className="text-lg font-bold text-white uppercase tracking-widest">{item.label}</p>
                       </div>
                    </motion.div>
                  ))}
               </div>
